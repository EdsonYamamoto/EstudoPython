...
def DetectarCaracteresNasPlacas(listaDePossiveisPlacas):
    ...
    for possivelPlaca in listaDePossiveisPlacas:
        ...
        possivelPlaca.imgEscalaDeCinza, possivelPlaca.imgThreshold = LeitorPlaca.Preprocesso.Preprocesso(possivelPlaca.imgPlaca)
    ...
    if LeitorPlaca.Main.mostrarPassos == True:
        print (
...
def encontrarPossivelCaractereNaPlaca(imgEscalaDeCinza, imgThreshold):
    ...
    for contour in contornos:  # para cada contorno
        possivelCaractere = LeitorPlaca.PossivelCaractere.PossivelCaractere(contour)
...
def recognizeCaracteresInPlaca(imgThreshold, listaDeCombinacaoDeCaracteres):
    ...
    for caractereAtual in listaDeCombinacaoDeCaracteres:
        ...
        cv2.rectangle(imgThresholdColor, pt1, pt2, LeitorPlaca.Main.ESCALA_VERDE, 2)
    ...
    if LeitorPlaca.Main.mostrarPassos == True:  # show steps #######################################################
